        ...
        <section className="py-12 md:py-20 px-4 md:px-6 bg-gradient-to-b from-secondary to-background">
          <div className="container max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              ...
              Browse our selection and find your perfect companion.
            </p>
        ...
        <section className="py-12 px-4 md:px-6">
          <div className="container max-w-6xl mx-auto">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold">Recent Arrivals</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Browse available pets, filter by type, size, and other preferences to find your perfect match.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Submit an adoption application and our team will review it to ensure a good match.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Once approved, complete the adoption process and welcome your new friend to their forever home.
                </p>
              </div>
            </div>
